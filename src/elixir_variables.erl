...
serialize_scope(S) ->
  elixir_tree_helpers:abstract_syntax(
    { S#elixir_scope.filename, S#elixir_scope.functions, S#elixir_scope.check_clauses, S#elixir_scope.requires,
...
deserialize_scope({ Filename, Functions, CheckClauses, Requires, Macros, Refer, Scheduled, Compile }) ->
  #elixir_scope{
    filename=Filename,
    functions=Functions,
