...
translate_each(Fun, {'{}',Line,[Key,Expr]}, S) when not is_list(Expr) ->
  translate_each(Fun, {'{}',Line,[Key,[Expr]]}, S);

translate_each(Fun, {'{}',Line,[else,Expr]}, S) ->
  Fun(Expr, S);

translate_each(Fun, {'{}',Line,[Key,[Expr]]}, S) ->
  translate_each(Fun, {'{}',Line,[Key,[Expr, nil]]}, S);

translate_each(Fun, {'{}',Line,[Key,[Condition|Exprs]]} = T, S) when Key == do; Key == elsif; Key == match ->
