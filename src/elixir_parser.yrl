...
Nonterminals
  ...
  match_op arrow_op module_ref_op default_op when_op pipe_op and_concat_op in_op
...
matched_op_expr -> matched_expr and_concat_op matched_expr : build_op('$2', '$1', '$3').
...
long_tuple_op_expr -> long_tuple and_concat_op matched_expr : build_op('$2', '$1', '$3').
