...
-export([assert_behavior/2, owner_methods/1, mixin_methods/1]).
-include("elixir.hrl").
...
owner_methods(Name) when is_atom(Name) ->
  ...
  convert_methods(Public -- defaults()).

% Helpers

defaults() ->
  [{module_info,0},{module_info,1},{'__elixir_exported__',2},{'__mixins__',1},{'__module_name__',1},{'__module__',1}].
