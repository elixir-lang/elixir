...
docs_elixir: compile ../ex_doc/bin/ex_doc
	@ echo "==> ex_doc (elixir)"
	$(Q) rm -rf doc/elixir
	$(call COMPILE_DOCS,Elixir,elixir,Kernel,-e "lib/elixir/pages/Naming_Conventions.md" -e "lib/elixir/pages/Typespecs.md" -e "lib/elixir/pages/Writing_Documentation.md")
