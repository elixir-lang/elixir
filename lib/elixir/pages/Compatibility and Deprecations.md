...
Elixir applies bug fixes only to the latest minor branch. Security fixes are available for the last 5 minor branches:

Elixir version | Support
:------------- | :----------------------
1.6            | Bug and security fixes
1.5            | Security fixes only
1.4            | Security fixes only
1.3            | Security fixes only
