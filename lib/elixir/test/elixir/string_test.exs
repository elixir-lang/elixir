...
defmodule StringTest do
  ...
  test :slice do
    ...
    assert String.slice("elixir", 1) == "lixir"
    assert String.slice("あいうえお", 2, 2) == "うえ"
    assert String.slice("あいうえお", 2) == "うえお"
    ...
    assert String.slice("elixir", -3) == "xir"
    assert String.slice("あいうえお", -4, 3) == "いうえ"
    assert String.slice("あいうえお", -4) == "いうえお"
    ...
    assert String.slice("ειξήριολ", -10) == ""
    assert String.slice("elixir", 8, 2) == ""
    assert String.slice("elixir", 8) == ""
    assert String.slice("あいうえお", 6, 2) == ""
    assert String.slice("あいうえお", 6) == ""
    ...
    assert String.slice("", 0) == ""
    assert String.slice("", 1, 1) == ""
    assert String.slice("", 1) == ""
