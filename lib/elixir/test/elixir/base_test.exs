...
defmodule BaseTest do
  ...
  test "decode16 invalid lowercase" do
  ...
  test "encode16 lowercase" do
    assert "" == encode16("", lowercase: true)
    assert "a1b2c3d4e5f67891" == encode16(<<161, 178, 195, 212, 229, 246, 120, 145>>, lowercase: true)
  end

  test "decode16 valid lowercase" do
    assert { :ok, "" } == decode16("", lowercase: true)
    assert { :ok, <<232>>} == decode16("e8", lowercase: true)
  end

  test "decode16! valid lowercase" do
    assert <<232>> == decode16!("e8", lowercase: true)
  end

  test "decode16 invalid uppercase" do
    assert :error == decode16("E8", lowercase: true)
  end

  test "decode16! invalid uppercase" do
    assert_raise ArgumentError, "non-alphabet digit found: E", fn ->
      decode16!("E8", lowercase: true)
    end
  end
  ...
  test "encode32 lowercase" do
    assert "" == encode32("", lowercase: true)
    assert "mzxw6ytb" == encode32("fooba", lowercase: true)
  end

  test "decode32 valid lowercase" do
    assert {:ok, ""} == decode32("", lowercase: true)
    assert {:ok, "fooba"} == decode32("mzxw6ytb", lowercase: true)
  end

  test "decode32! valid lowercase" do
    assert "fooba" == decode32!("mzxw6ytb", lowercase: true)
  end

  test "decode32 invalid uppercase" do
    assert :error == decode32("MZXW6YTB", lowercase: true)
  end

  test "decode32! invalid uppercase" do
    assert_raise ArgumentError, "non-alphabet digit found: M", fn ->
      decode32!("MZXW6YTB", lowercase: true)
    end
  end
  ...
  test "hex_decode32 invalid lowercase" do
    assert :error == hex_decode32("cpnmuoj1")
  end

  test "hex_encode32 lowercase" do
    assert "" == hex_encode32("", lowercase: true)
    assert "cpnmuoj1" == hex_encode32("fooba", lowercase: true)
  end

  test "hex_decode32 valid lowercase" do
    assert {:ok, ""} == hex_decode32("", lowercase: true)
    assert {:ok, "fooba"} == hex_decode32("cpnmuoj1", lowercase: true)
  end

  test "hex_decode32! valid lowercase" do
    assert "fooba" == hex_decode32!("cpnmuoj1", lowercase: true)
  end

  test "hex_decode32 invalid uppercase" do
    assert :error == hex_decode32("CPNMUOJ1", lowercase: true)
  end

  test "hex_decode32! invalid uppercase" do
    assert_raise ArgumentError, "non-alphabet digit found: C", fn ->
      hex_decode32!("CPNMUOJ1", lowercase: true)
    end
  end
