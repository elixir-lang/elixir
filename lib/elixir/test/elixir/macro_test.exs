...
defmodule MacroTest do
  ...
  test "pascalize/1" do
    assert Macro.pascalize("Foo") == "Foo"
    assert Macro.pascalize("FooBar") == "FooBar"
    assert Macro.pascalize("foo") == "Foo"
    assert Macro.pascalize("foo_bar") == "FooBar"
    assert Macro.pascalize("foo_") == "Foo"
    assert Macro.pascalize("_foo") == "Foo"
    assert Macro.pascalize("foo10") == "Foo10"
    assert Macro.pascalize("_10foo") == "10foo"
    assert Macro.pascalize("foo_10") == "Foo10"
    assert Macro.pascalize("foo__10") == "Foo10"
    assert Macro.pascalize("foo__bar") == "FooBar"
    assert Macro.pascalize("foo/bar") == "Foo.Bar"
    assert Macro.pascalize("Foo.Bar") == "Foo.Bar"
    assert Macro.pascalize("foo1_0") == "Foo10"
    assert Macro.pascalize("foo_123_4_567") == "Foo1234567"
    assert Macro.pascalize("FOO_BAR") == "FOO_BAR"
    assert Macro.pascalize("FOO.BAR") == "FOO.BAR"
    assert Macro.pascalize("") == ""
  end
end
