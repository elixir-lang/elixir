...
defmodule NaiveDateTimeTest do
  ...
  test "utc_ago/1" do
    naive_datetime = NaiveDateTime.utc_ago(day: 1)
    expected = NaiveDateTime.add(NaiveDateTime.utc_now(), -1, :day)

    assert naive_datetime.day == expected.day
  end

  test "utc_from_now/1" do
    naive_datetime = NaiveDateTime.utc_from_now(day: 1)
    expected = NaiveDateTime.add(NaiveDateTime.utc_now(), 1, :day)
