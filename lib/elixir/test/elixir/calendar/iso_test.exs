...
defmodule Calendar.ISOTest do
  ...
  describe "shift_date/2" do
    test "regular use" do
      ...
      assert Calendar.ISO.shift_date(2024, 3, 2, hour: 24) == {2024, 3, 3}
      assert Calendar.ISO.shift_date(2024, 3, 2, minute: 1440) == {2024, 3, 3}
      assert Calendar.ISO.shift_date(2024, 3, 2, second: 86400) == {2024, 3, 3}
      assert Calendar.ISO.shift_date(2024, 3, 2, microsecond: 86400 * 1_000_000) == {2024, 3, 3}
