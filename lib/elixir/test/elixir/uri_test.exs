...
defmodule URITest do
  ...
  test "is_uri/1" do
    ...
    assert URI.is_uri?("http://foo.com/blah_blah") == true
    assert URI.is_uri?("http://foo.com/blah_blah_(wikipedia)") == true
    ...
    assert URI.is_uri?("http://userid@example.com/") == true
    assert URI.is_uri?("http://userid@example.com:8080") == true
    assert URI.is_uri?("http://userid@example.com:8080/") == true
