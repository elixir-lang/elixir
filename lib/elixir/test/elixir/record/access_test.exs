...
defmodule Record.AccessTest do
  ...
  test "access with update" do
    user = User[User[], age: 1, name: :ok]
    assert User[age: 1, name: :ok] == user
  end

  test "access with fields retrieval" do
    assert User[User[], :age] == 0
    assert User[User[], [:age, :name]] == [0, nil]
  end
