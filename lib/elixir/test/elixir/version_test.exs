...
defmodule VersionTest do
  ...
  test "^" do
    ...
    refute Version.match?("1.1.1-pre", "^ 1", allow_pre: false)
    refute Version.match?("0.1.0-alpha", "^ 1", allow_pre: true)
    refute Version.match?("1.0.0-beta1", "^ 1", allow_pre: true)
    assert Version.match?("1.1.1-pre", "^ 1", allow_pre: true)
    ...
    refute Version.match?("1.1.1-pre", "^ 1.1", allow_pre: false)
    refute Version.match?("0.1.0-alpha", "^ 1.1", allow_pre: true)
    refute Version.match?("1.0.0-beta1", "^ 1.1", allow_pre: true)
    assert Version.match?("1.1.1-pre", "^ 1.1", allow_pre: true)
    ...
    refute Version.match?("1.1.1-alpha1", "^ 1.1.1", allow_pre: true)
    assert Version.match?("1.1.2-beta1", "^ 1.1.1", allow_pre: true)
    refute Version.match?("2.0.0-pre", "^ 1.1.1", allow_pre: true)
    ...
    refute Version.match?("0.1.1-alpha1", "^ 0.1.1", allow_pre: true)
    assert Version.match?("0.1.2-beta1", "^ 0.1.1", allow_pre: true)
    refute Version.match?("0.2.0-pre", "^ 0.1.1", allow_pre: true)
