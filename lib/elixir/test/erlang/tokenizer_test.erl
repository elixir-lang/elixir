...
chars_test() ->
  ...
  [{number,{1,1,5},0}]       = tokenize("?\\0"),
  [{number,{1,1,5},7}]       = tokenize("?\\a"),
  [{number,{1,1,5},10}]      = tokenize("?\\n"),
  [{number,{1,1,6},92}]      = tokenize("?\\\\"),
  [{number,{1,1,6},10}]      = tokenize("?\\xa"),
  [{number,{1,1,8},10}]      = tokenize("?\\x{a}"),
  [{number,{1,1,9},171}]     = tokenize("?\\x{ab}"),
  [{number,{1,1,10},2748}]    = tokenize("?\\x{abc}"),
  [{number,{1,1,11},43981}]   = tokenize("?\\x{abcd}"),
  [{number,{1,1,12},703710}]  = tokenize("?\\x{abcde}"),
  [{number,{1,1,13},1092557}] = tokenize("?\\x{10abcd}").
