...
defmodule Macro do
  ...
  def generate_arguments(amoung, context) when is_integer(amoung) and amoung > 0 and is_atom(context) do
    for id <- 1..amoung, do: Macro.var(String.to_atom("var" <> Integer.to_string(id)), context)
  end
