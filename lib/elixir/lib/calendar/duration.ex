defmodule Duration do
  ...
  """
  @spec compare(t, t, Calendar.calendar()) :: :lt | :eq | :gt
  def compare(
        %Duration{microsecond: m1} = d1,
        %Duration{microsecond: m2} = d2,
        calendar \\ Calendar.ISO
      ) do
    case {to_seconds(d1, calendar) + m1, to_seconds(d2, calendar) + m2} do
