defmodule NaiveDateTime do
  ...
  To shift a naive datetime by a complex duration supporting various units including years,
  months, weeks, days and time units, you can use `NaiveDateTime.shift/2`.
  """
  @doc since: "1.4.0"
