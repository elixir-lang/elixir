defmodule IO do
  ...
  `stream/1` has been introduced in Elixir v1.12.0, while `stream/2` has been available since v1.0.0.
  ...
  `binstream/1` has been introduced in Elixir v1.12.0, while `binstream/2` has been available since v1.0.0.
  """
