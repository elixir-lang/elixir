defmodule GenServer do
  ...
  exits: if the `GenServer` itself crashes, `c:terminate/2` will not be called,
  whether exits are being trapped or not.
  For such reasons, we usually recommend important clean-up rules to
