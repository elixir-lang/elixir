  ...
  *Note*: unlike `@after_compile`, the callback function/macro must
  ...
  defp simplify_arg({:%, _, [left, _]}, acc, env) do
    case Macro.expand_once(left, env) do
      module when is_atom(module) -> autogenerated_key(acc, simplify_module_name(module))
      _ -> autogenerated_key(acc, :struct)
    end
  end

  defp simplify_arg({:%{}, _, _}, acc, _env) do
    autogenerated_key(acc, :map)
  end
  ...
  defp simplify_arg(other, acc, _env) when is_integer(other), do: autogenerated_key(acc, :int)
  defp simplify_arg(other, acc, _env) when is_boolean(other), do: autogenerated_key(acc, :bool)
  defp simplify_arg(other, acc, _env) when is_atom(other), do: autogenerated_key(acc, :atom)
  defp simplify_arg(other, acc, _env) when is_list(other), do: autogenerated_key(acc, :list)
  defp simplify_arg(other, acc, _env) when is_float(other), do: autogenerated_key(acc, :float)
  defp simplify_arg(other, acc, _env) when is_binary(other), do: autogenerated_key(acc, :binary)
  defp simplify_arg(_, acc, _env), do: autogenerated_key(acc, :arg)
  ...
  defp autogenerated_key(acc, key) do
    case acc do
