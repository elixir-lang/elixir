...
defmodule Enum do
  ...
  def chunk(enumerable, count) when is_integer(count) and count > 0,
    do: chunk(enumerable, count, count, nil)
  ...
  defp take_last([], [], _, acc),
    do: acc
  defp take_last([], [head | tail], count, acc),
    do: take_last([], tail, count - 1, [head | acc])
