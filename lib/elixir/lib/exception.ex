...
defmodule SyntaxError do
  ...
  def message(%{
    ...
    snippet =
      :elixir_errors.format_snippet({line, column}, file, description, snippet, :error, [], 1)
  ...
  def message(%{
    ...
    snippet = :elixir_errors.format_snippet({line, column}, file, description, nil, :error, [], 1)
