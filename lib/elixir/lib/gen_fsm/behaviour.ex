defmodule GenFSM.Behaviour do
  ...
  and GenFSM is an OTP behaviour that encapsulates common FSM
  functionalities.
  ...
  you press the request button the CVM will brew coffee if you
  have paid enough coins, if not it will wait until you have inserted
  enough coins and it will instantly brew the coffee since you
