defprotocol Collectable do
  ...
  it doesn't make sense to insert values into a [range](`t:Range.t/0`), as it has a fixed
  shape where just the range [limits](`t:Range.limit/0`) and the [step](`t:Range.step/0`) are stored.
