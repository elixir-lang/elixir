...
object RecordTest
  ...
  def record_reflection_test
    ...
    ['assign,'guard,'method,'scope,'vars,'temp_vars,'clause_vars,'counter,'filename,'assigned_vars] = record.record_keys
    [false,false,[],{[], []},_,[],_,0,$"nofile",_] = record.record_defaults
    10 = record.record_size
  end
